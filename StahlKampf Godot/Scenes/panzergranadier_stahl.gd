extends Node2D
var cell_size = 80
#LEGIERTEM STAHL PANZERGRANADIER

# Propriedades
export var moves = 2 #numero de moves
export var hp = 3
...
func play_selection_sound():
	var sound = randi() % 14 #GERA UM VALOR DE 0 A 14 PARA AS VOZES
	if(sound==1 or sound ==0):
		get_node("../Sound/Robot_voices").play("Robot1")
	elif(sound==2):
		get_node("../Sound/Robot_voices").play("Robot2")
	elif(sound==3):
		get_node("../Sound/Robot_voices").play("Robot3")
	elif(sound==4):
		get_node("../Sound/Robot_voices").play("Robot4")
	elif(sound==5):
		get_node("../Sound/Robot_voices").play("Robot5")
	elif(sound==6):
		get_node("../Sound/Robot_voices").play("Robot6")
	elif(sound==7):
		get_node("../Sound/Robot_voices").play("Robot7")
	elif(sound==8):
		get_node("../Sound/Robot_voices").play("Robot8")
	elif(sound==9):
		get_node("../Sound/Robot_voices").play("Robot9")
	elif(sound==10):
		get_node("../Sound/Human_voices").play("Robot10")
	elif(sound==11):
		get_node("../Sound/Robot_voices").play("HeavyRobot1")
	elif(sound==12):
		get_node("../Sound/Robot_voices").play("HeavyRobot2")
	elif(sound==13):
		get_node("../Sound/Human_voices").play("HeavyRobot3")
#--------------------------------------------------------------------------------	
#********
...
func attack(var target_path): #FUNÇÃO DE ATAQUE
	...
	hp = hp - atk 
	get_node("../Sound/War_melodies").play("Panzerschreck")
