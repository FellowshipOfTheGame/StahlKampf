...
func play_selection_sound():
	...
	if(sound==1 or sound == 0):
		...
		get_node("../Sound/Robot_voices").play("ScoutRobot1")
	elif(sound==12):
		get_node("../Sound/Robot_voices").play("ScoutRobot2")
	elif(sound==13):
		get_node("../Sound/Human_voices").play("ScoutRobot3")
#--------------------------------------------------------------------------------	
#********
...
func attack(var target_path): #FUNÇÃO DE ATAQUE
	...
	hp = hp - atk 
	get_node("../Sound/War_melodies").play("Atira e recarrega")
