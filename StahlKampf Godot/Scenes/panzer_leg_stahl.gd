...
func play_selection_sound():
	var sound = randi() % 15 #GERA UM VALOR DE 0 A 14 PARA AS VOZES
	if(sound==1):
		...
		get_node("../Sound/Robot_voices").play("TankRobot1")
	elif(sound==12):
		get_node("../Sound/Robot_voices").play("TankRobot2")
	elif(sound==13):
		get_node("../Sound/Robot_voices").play("TankRobot3")
	elif(sound==14):
		get_node("../Sound/Human_voices").play("TankRobot4")	
#--------------------------------------------------------------------------------	
#********
