...
func play_selection_sound():
	...
	if(sound==1):
		...
		get_node("../Sound/Human_voices").play("Heavy1") #PARA PANZERGRANADIER
	elif(sound==10):
		get_node("../Sound/Human_voices").play("Heavy2")
	elif(sound==11):
		get_node("../Sound/Human_voices").play("Heavy3")
#--------------------------------------------------------------------------------	
#********
